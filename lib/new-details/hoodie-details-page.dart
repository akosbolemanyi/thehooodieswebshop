import 'package:android_studio_projects/new-details/product_title_with_image.dart';
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        const SizedBox(height: kDefaultPaddin / 2),
                        CounterWithFavBtn(hoodie: widget.hoodie, onQuantityChanged: updateQuantity),
                        const SizedBox(height: kDefaultPaddin / 2),
                        AddToCart(
                          hoodie: widget.hoodie,
