...
class AddToCart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int availableQuantity = stockQuantity - cartQuantity; // A raktáron lévő mennyiség - ami már a kosárban van

    bool isOutOfStock = availableQuantity <= 0 || quantity > availableQuantity;

    void showOutOfStockMessage() {
      Utils.showSnackBar("A termék nincs raktáron vagy túl sokat választottál!");
    }
          ...
          Container(
            ...
            child: IconButton(
              ...
              onPressed: isOutOfStock
                  ...
                  : () async {
                int index = cartModel.shopItems.indexWhere((item) => item['id'] == hoodie.itemName);
                if (index != -1) {
