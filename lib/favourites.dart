      ...
      MaterialPageRoute(
        builder: (context) => HoodieDetailsPage(
          hoodie: HoodieItemTile(
            itemName: item['name'],
            itemPrice: item['sizes']['m']['priceHuf'], // Alapértelmezett M méretű ár
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Favourites', style: GoogleFonts.cabin(fontWeight: FontWeight.bold, color: Colors.black)),
        actions: [
          IconButton(
